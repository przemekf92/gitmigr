...
def exitusage(code: int=1, usestdout: bool=False):
  ...
  out.write("\n")
  out.write("  If remote git repositories have been migrated to another location, this command-line utility can migrate local clones of these repositories by updating their configuration. Submodules are supported.\n")
  out.write("\n")
